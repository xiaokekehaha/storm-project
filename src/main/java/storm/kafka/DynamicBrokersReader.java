...
public class DynamicBrokersReader {
    ...
    public DynamicBrokersReader(Map conf, String zkStr, String zkPath, String topic) {
        ...
        try {
			_curator = CuratorFrameworkFactory.newClient(
			        ...
			        15000,
			        new RetryNTimes(Utils.getInt(conf.get(Config.STORM_ZOOKEEPER_RETRY_TIMES)), Utils.getInt(conf.get(Config.STORM_ZOOKEEPER_RETRY_INTERVAL))));
    ...
    public GlobalPartitionInformation getBrokerInfo() {
        ...
        //globalPartitionInformation.addPartition(0, new Broker("192.168.90.116",9092));
        //globalPartitionInformation.addPartition(1, new Broker("192.168.90.116",9092));
        try {
            ...
            for (int partition = 0; partition < numPartitionsForTopic; partition++) {
                ...
                try {
                    ...
                    // 没有该路径，此处会抛出异常信息
                    //byte[] bytes = _curator.getZookeeperClient().getZooKeeper().getData("/testPath", null, null);
     ...
     * @return
     */
    //   /brokers/topics/apppush/partitions
